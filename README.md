...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
   Provides meaning to content of a webpage.

2. Name two big differences between `display: block;` and `display: inline;`.
   With display: inline-block the top and bottom margins and paddings are respected, but with display: inline they are not. Also, display: inline-block does not add a line-break after the element.
...
5. Explain why git is valuable to a team of developers.
   Collaboration is organized in a well structured platform which optimizes code and proficency.
